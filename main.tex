...
\section{Our Model}
\input{sections/our-model.tex}

% \subsubsection{Relational Database Framework}
% \input{sections/intro/er-diagram.tex}

% \section{Entities}

% \subsection{Repository}
% \input{sections/repository.tex}

% \subsection{Historical Document}
% \input{sections/historical_document.tex}

% \subsection{Pages}
% \input{sections/pages.tex}

% \subsection{Witness}
% \input{sections/witness.tex}
